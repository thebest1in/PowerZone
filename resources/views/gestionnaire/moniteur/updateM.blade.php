        ...
        <div class="row align-items-center">
          ...
          <form action="/modifierMoniteur" method="post" style="margin:20px">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nom" aria-describedby="emailHelp"  value="{{$i->nom}}" style="margin:20px" required>
                  <input type="hidden" class="form-control" name="code" aria-describedby="emailHelp" value="{{$i->codeM}}" style="margin:20px" >
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Prenom</label>
                  <input type="text" class="form-control" name="prenom"  value="{{$i->prenom}}" style="margin:20px" required>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Tel</label>
                  <input type="number" class="form-control" name="tel" aria-describedby="emailHelp" value="{{$i->tel}}" style="margin:20px" required>
                </div>
                @endforeach
