...
<a href="/ajouterActivites" class="btn btn-primary" ><i class="ti-plus"></i> Activite</a></div><hr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/deleteActivites/{{$i->idAct}}" class="btn btn-danger"><i class="ti-trash"></i></a>
      </td>
    </tr>
    @endforeach
  </tbody>
