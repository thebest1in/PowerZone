...
<nav>
<a href="/gestionnaire/adherents/{{$groupe[0]->idgroupe}}" class="btn btn-warning" style="font-size:2em"><i class="ti-arrow-left"></i></a>
</nav><hr>
...
<div class="intro-section" id="home" style="background-color: #eee ;">
      <div class="container">
        <div class="row align-items-center">
          ...
          <form action="/modifierGroupes" method="post" style="margin:20px">
                @csrf
                <div class="form-group">  
                  <label>Nom de Groupe</label>
                  <input type="text" class="form-control" name="nom" style="margin:20px" value="{{$groupe[0]->nomgroupe}}" required>
                  <input type="hidden" class="form-control" name="id" value="{{$groupe[0]->idgroupe}}" style="margin:10px">
                </div>
                <button type="submit" class="btn btn-primary" style="margin-top:20px">modifier</button> &mdash;
                <a href="/gestionnaire/adherents/{{$groupe[0]->idgroupe}}" class="btn btn-secondary" style="margin-top:20px">Annuler</a> 
          </form>
          </div>
        </div>
      </div>
