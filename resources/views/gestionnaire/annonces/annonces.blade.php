...
<a href="/ajouterAnnonces" class="btn btn-primary" ><i class="ti-plus"></i> Annonces</a></div><hr>
...
<table class="table  table-hover" style="text-align:center">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="/updateAnnonces/{{$i->idAn}}" class="btn btn-primary"><i class="ti-pencil"></i></a>
        <a href="/deleteAnnonces/{{$i->idAn}}" class="btn btn-danger"><i class="ti-trash"></i></a>
      </td>
    </tr>
    @endforeach
  </tbody>
