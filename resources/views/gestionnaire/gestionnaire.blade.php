    ...
    @section("nav")
        ...
        <div class="intro-section" id="home" style="background-color: #eee ;">
            <div class="container">
                ...
                <h2 style="color:black">Bonjour {{$gestionnaire[0]->nom}} {{$gestionnaire[0]->prenom}}</h2><hr>
                <strong>- - - -  </strong><hr>
                        <a href="/gestionnaire/groupes" class="btn btn-warning" style="width:40%">groupes</a>
                        <a href="/gestionnaire/moniteur" class="btn btn-warning" style="width:40%">moniteur</a><hr>
                        <a href="/gestionnaire/activites" class="btn btn-warning" style="width:40%">Activités</a>
                        ...
                        <a href="/gestionnaire/demandes" class="btn btn-warning" style="width:40%">demandes</a>
                        <a href="/gestionnaire/annonces" class="btn btn-warning" style="width:40%">annonces</a><hr>
                        <a href="/gestionnaire/compte" class="btn btn-warning" style="width:40%">profil</a>
                </div>
