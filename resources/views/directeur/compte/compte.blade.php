...
@isset($directeur)
  ...
  <div class="intro-section" id="home" style="background-color: #eee ;">
        <div class="container">
          <div class="row align-items-center">
            ...
            <form action="/updateDirecteur" method="post" style="margin:20px">
                  @csrf
                  <table>
                  <tr>
                    <td> <label>Nom : </label> </td>
                    <td> <input type="text" name="nom" style="margin:20px" value="{{$directeur[0]->nom}}" required> </td>
  </tr>
  <tr>
                <td> <label>Prenom : </label> </td>
                <td> <input type="text" name="prenom" style="margin:20px" value="{{$directeur[0]->prenom}}" required> </td>
  </tr>
  <tr>
                <td> <label>Email address : </label> </td>
                <td> <input type="email" name="email" aria-describedby="emailHelp" style="margin:20px" value="{{$directeur[0]->email}}" required></td>

  </tr>
  <tr>
                <td> <label>Password : </label></td>
                <td> <input type="text" name="password" style="margin:20px" value="{{$directeur[0]->password}}" required></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td> <a href="/directeur" class="btn btn-danger">Annuler</a> </td>
  </tr>
        </table> 
            </form>
            </div>
